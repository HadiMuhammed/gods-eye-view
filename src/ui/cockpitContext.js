...
import { bearingBetweenCoordinates, formatCockpitContextScope, relativeBearing, resolveCockpitContextReadout } from '../cockpitMath.js';

export function updateContext(info, heading) {
    if (!this.context) return;
    const snapshot = this.services.militaryAwarenessLayer.getContextSnapshot?.() || null;
